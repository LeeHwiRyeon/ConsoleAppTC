...
namespace MiniGameTC {
    internal class RPSTC_UserWinTestCase : RockPaperScissorsTestCaseBase {
        public override TCResult OnUpdate()
        {
            ...
            if (m_miniGame.Play() != GameResult.Win) {
                ...
                Result.ErrorMessage = "Scenario 1: User Win failed!";
                return Result;
            }
            ...
            if (m_miniGame.Play() != GameResult.Win) {
                Result.Status = "Failed";
                Result.ErrorMessage = "Scenario 2: User Win failed!";
                return Result;
            }
            ...
            if (m_miniGame.Play() != GameResult.Win) {
                Result.Status = "Failed";
                Result.ErrorMessage = "Scenario 3: User Win failed!";
                return Result;
            }
